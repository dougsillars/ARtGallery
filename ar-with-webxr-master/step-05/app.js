...
class App {
  ...
  async onSessionStarted(session) {
	...
	geometry.translate( -0.25, 0.25, 0 );
		...
		let materialArray1 = [
    		new THREE.MeshBasicMaterial( { map: loader.load("../assets/scream.jpg") } ),
   			 new THREE.MeshBasicMaterial( { map: loader.load("../assets/scream.jpg") } ),
   			 new THREE.MeshBasicMaterial( { map: loader.load("../assets/scream.jpg") } ),
   			 new THREE.MeshBasicMaterial( { map: loader.load("../assets/scream.jpg") } ),
   			 new THREE.MeshBasicMaterial( { map: loader.load("../assets/scream.jpg") } ),
		...
		let materialArray2 = [
    		new THREE.MeshBasicMaterial( { map: loader.load("../assets/monalisa.jpg") } ),
   			 new THREE.MeshBasicMaterial( { map: loader.load("../assets/monalisa.jpg") } ),
   			 new THREE.MeshBasicMaterial( { map: loader.load("../assets/monalisa.jpg") } ),
   			 new THREE.MeshBasicMaterial( { map: loader.load("../assets/monalisa.jpg") } ),
   			 new THREE.MeshBasicMaterial( { map: loader.load("../assets/monalisa.jpg") } ),
    ...
    //geometry.applyMatrix(new THREE.Matrix4().makeTranslation(0, 0.25, 0));
     var scream = new THREE.Mesh(geometry, materialArray1);
     scream.scale.set( 1, 1, 0.01 );
